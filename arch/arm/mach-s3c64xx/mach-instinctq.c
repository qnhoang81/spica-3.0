...
static struct s3c_pin_cfg_entry instinctq_slp_config[] __initdata = {
	...
	/* GPA */
	S3C64XX_PIN(GPA(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPA(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPA(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPA(5)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPA(6)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C_PIN(GPIO_BT_RST), S3C64XX_PIN_SLP(RETAIN), S3C_PIN_PULL(NONE),
	...
	S3C64XX_PIN(GPB(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),	
	S3C64XX_PIN(GPB(5)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPB(6)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),


	/* GPC */
	S3C_PIN(GPIO_SCAM_RST_N), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_SCAM_STANDBY), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPC(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPC(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPC(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPC(5)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C_PIN(GPIO_WLAN_WAKE), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_BT_WAKE), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),

	/* GPD */
	S3C64XX_PIN(GPD(0)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C_PIN(GPIO_BT_WLAN_REG_ON), S3C64XX_PIN_SLP(RETAIN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPD(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPD(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPD(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	...
	/* GPF */
	S3C64XX_PIN(GPF(0)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(1)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C_PIN(GPIO_MCAM_RST_N), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE), 
	S3C64XX_PIN(GPF(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(5)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(6)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(7)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(8)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(9)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(10)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(11)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN), 
	S3C64XX_PIN(GPF(12)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C_PIN(GPIO_LUM_PWM), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE), 

	/* GPG */
	S3C64XX_PIN(GPG(0)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPG(1)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPG(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPG(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPG(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPG(5)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),	
	
	/* GPH */
	S3C_PIN(GPIO_CAM_STANDBY), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_TFLASH_EN), S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPH(6)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPH(7)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPH(8)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C64XX_PIN(GPH(9)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),

	/* GPI */
	S3C64XX_PIN(GPI(0)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(1)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(8)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(9)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(10)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(11)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(12)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPI(13)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),

	/* GPJ */
	S3C64XX_PIN(GPJ(0)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(1)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(2)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(3)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(4)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(8)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(9)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(10)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),
	S3C64XX_PIN(GPJ(11)), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(DOWN),

	/* GPM */
	S3C_PIN(GPIO_FM_I2C_SCL), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_FM_I2C_SDA), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_CHG_ING_N), S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_PDA_ACTIVE), S3C_PIN_OUT(0), S3C_PIN_PULL(NONE),
